...
VorticityFieldNode::VorticityFieldNode(const std::string& name,
...
void VorticityFieldNode::init(Configuration& cfg, RenderAttachments& attachments)
{
...
void VorticityFieldNode::createFramebuffer()
{
...
void VorticityFieldNode::createRenderPass()
{
...
void VorticityFieldNode::createPipeline(Configuration& cfg)
{
...

    {
        ...
        auto vertShaderCode = readFile(cfg.shader_directory + "/vorticity_field/node.vert.spv");

        auto frag_shader_path = std::filesystem::path(cfg.engine_directory) / "function/render/render_graph/node/vorticity_field/node.frag";
        auto filename = frag_shader_path.filename().string();
        auto generated_path = cfg.shader_directory + "/vorticity_field/generated/" + filename;
        auto generated_spv = cfg.shader_directory + "/vorticity_field/" + (filename + ".spv");
...
void VorticityFieldNode::record(uint32_t swapchain_index)
{
...
void VorticityFieldNode::onResize()
{
