...
void FireFieldNode::createPipeline(Configuration& cfg)
{
...

    {
        ...
        auto vertShaderCode = readFile(cfg.at("shader_directory").get<std::string>() + "/fire_field/node.vert.spv");
        ...
        auto generated_path = cfg.at("shader_directory").get<std::string>() + "/fire_field/generated/" + filename;
        auto generated_spv = cfg.at("shader_directory").get<std::string>() + "/fire_field/" + (filename + ".spv");
